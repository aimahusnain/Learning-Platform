...
<button
        ...
        >
          <div className={`bg-gray-50 ${isFullscreen && sentences[currentIndex].includes("<br />") && "mt-[160px]"} rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 shadow-inner`}>
            <p
