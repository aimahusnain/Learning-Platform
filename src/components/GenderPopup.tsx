...
import { BookHeart, PersonStanding } from 'lucide-react';
...
const GenderPopup: React.FC<GenderPopupProps> = ({ onSelect }) => {
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">Welcome to WordWise!</h2>
        ...
        <div className="flex justify-center space-x-6">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <PersonStanding className="w-16 h-16 text-blue-600 mb-2" />
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <BookHeart className="w-16 h-16 text-pink-600 mb-2" />
            <span className="text-lg font-semibold text-pink-800">Female</span>
          </motion.button>
        </div>
        <p className="mt-6 text-sm text-gray-500 text-center">
          This helps us tailor our content to you. You cannot change this later in your settings.
        </p>
      </motion.div>
    </motion.div>
  );
