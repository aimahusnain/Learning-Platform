    ...
    "data set 5": [
      {
        name: "Positive" as const,
        sentence: [
          "People are going to Changa Manga for picnic.",
          "The boy is preparing well for the examination.",
          "The chicks are running.",
          "I'm making the map of Pakistan.",
          "The milk man is milking the cow.",
          ...
          "The rickshaw isn't coming this way.",
          "People aren't going to the airport.",
          "Children aren't making a noise.",
          "I'm not telling him the secret.",
          "We aren't waiting for anyone here.",
          "She isn't smiling.",
          "The dogs aren't fighting over the bone.",
          "We aren't dividing the property.",
          "You aren't co-operating with your companion.",
          "The noble man isn't looking down upon you.",
          "He isn't facing the danger bravely.",
          "The driver isn't driving the car fast.",
          "I'm not making tea.",
          "Children aren't catching butterflies.",
          "I'm not wasting time.",
          "You aren't giving me your address.",
          "He’s not leading the procession.",
          "The governor isn't presiding over the meeting.",
          "He isn't working honestly.",
          "You aren't criticizing my opinion.",
          "This officer isn't neglecting his duties.",
          "The workers aren’t shirking work.",
          "We aren't smelling the flowers.",
          "The girls aren’t dozing off in class.",
          "He isn't feeling ashamed of his sin.",
          "The cook isn't preparing the meal.",
          "The boys aren’t drinking sugarcane juice.",
          "The woman isn't crying for help.",
          "Amjad isn't changing clothes.",
          "The woman isn't working the grinding stone."
        ]
