...
const Card: React.FC<{ learnAbout: string; data: any }> = ({
  ...
  >({
    "Who/What (Noun)": { Positive: 0 },
    "Where (Prepositional Phrase)": { Positive: 0 },
    "How (Adjective)": { Positive: 0 },
    "data set 3": { Positive: 0 },
    "data set 4": { Positive: 0 },
    "data set 5": { Positive: 0 },
    "data set 6": { Positive: 0 },
    "data set 7": { Positive: 0 },
  });
  ...
  >({
    "How (Adjective)": "Positive",
    "Who/What (Noun)": "Positive",
    "Where (Prepositional Phrase)": "Positive",
    "data set 3": "Positive",
    "data set 4": "Positive",
    "data set 5": "Positive",
    "data set 6": "Positive",
